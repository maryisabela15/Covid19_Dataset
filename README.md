...
* Both projects where created using PosgreSQL, and in both cases it was necessary create tables in a database to store the information content in the cvs files
